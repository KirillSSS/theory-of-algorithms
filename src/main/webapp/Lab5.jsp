<%-- 
    Document   : Lab5
    Created on : Apr 30, 2021, 1:50:50 AM
    Author     : savch
--%>
...
<html>
    ...
    <body>
        ...
        <h3 align="center">Complete the task with the lists</h3>
...
The IoT was initially most interesting to business and manufacturing, where its application is sometimes known as machine-to-machine (M2M), but the emphasis is now on filling our homes and offices with smart devices, transforming it into something that's relevant to almost everyone. Early suggestions for internet-connected devices included 'blogjects' (objects that blog and record data about themselves to the internet), ubiquitous computing (or 'ubicomp'), invisible computing, and pervasive computing. However, it was Internet of Things and IoT that stuck.</h4>
        ...
        <h2 align="center">Unsorted list of string values</h2>
        <h2 align="center" style="color:#1E90FF"><%=request.getAttribute("t2s")%></h2>
        <p align="center"> ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- </p>
        
        <h2 align="center">Unsorted list of byte values</h2>
        <h2 align="center" style="color:#1E90FF"><%=request.getAttribute("t2b")%></h2>
        <p align="center"> ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- </p>
        
        <h2 align="center">Sorted list of string values</h2>
        <h2 align="center" style="color:#1E90FF"><%=request.getAttribute("sortedt2s")%></h2>
        <p align="center"> ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- </p>
        
        <h2 align="center">Sorted list of byte values</h2>
